		...
		<header className="border-b [background:var(--card-bg)] border-card-border">
			<div className="flex w-full flex-col gap-4 px-8 py-4 sm:flex-row sm:items-center sm:justify-between sm:gap-0 sm:px-12 md:px-16 lg:px-20 xl:px-24">
				...
				<nav className="flex shrink-0 items-center gap-2">
					<Link href="/gfe75" className="rounded-md px-3 py-2 text-sm font-medium text-muted hover:[background:var(--surface)]">
						GFE 75
					</Link>
					<Link href="/blind75" className="rounded-md px-3 py-2 text-sm font-medium text-muted hover:[background:var(--surface)]">
						Blind 75
					</Link>
				</nav>
			</div>
