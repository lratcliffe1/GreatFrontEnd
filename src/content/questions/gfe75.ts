import { Category, Difficulty, QuestionStatus, SolutionType, Tag, Track, type Question } from "./types";
...
Implement a debounce function that accepts a callback and a wait duration, and returns a debounced version of that callback.`,
	...
	},
	{
		...
		tags: [Tag.Polyfill],
		status: QuestionStatus.Done,
		summary: `Array.prototype.reduce "reduces" elements by calling a reducer callback on each element in order, passing the previous return value. The final result is a single value.

Implement Array.prototype.myReduce to match the native reduce behavior, including edge cases: empty array (with/without initial), single element, sparse arrays.`,
		cardSummary: "Implement the Array.prototype.reduce() method",
		approach:
			"If empty and no initialValue, throw TypeError. If empty with initialValue, return it. Otherwise set accumulator and start index from initialValue (0 or 1), then loop and call callback(acc, arr[i], i, arr).",
...
Example: throttle(increment, 100) — at t=0 call executes (i=1), at t=50 call is skipped, at t=101 call executes (i=2).`,
	...
	},
	{
		...
		tags: [Tag.UiComponent, Tag.GraphQL, Tag.Redux],
		status: QuestionStatus.Done,
...
- Provide guardrails with disabled empty-submit and disabled clear-all when there are no tasks.`,
	...
	},
	{
		...
		sourceUrl: "https://www.greatfrontend.com/interviews/gfe75",
		solutionTypes: [SolutionType.UiDemo],
		tags: [Tag.Form, Tag.UiComponent, Tag.API],
		status: QuestionStatus.Done,
...
- POST to https://questions.greatfrontend.com/api/questions/contact-form with body fields: name, email, message`,
	...
	},
	{
		...
		solutionTypes: [SolutionType.UiDemo],
		tags: [Tag.Accessibility, Tag.Performance, Tag.GraphQL, Tag.Redux],
		status: QuestionStatus.Done,
...
- Add live updates (WebSocket/SSE), plus optimistic comments/shares using the same mutation pattern.`,
	...
	},
	{
		...
		tags: [Tag.Accessibility, Tag.UiComponent],
		status: QuestionStatus.InProgress,
	...
	},
	{
		...
		sourceUrl: "https://www.greatfrontend.com/interviews/gfe75",
		solutionTypes: [],
		tags: [Tag.Recursion, Tag.ObjectUtilities],
		status: QuestionStatus.Todo,
...
Implement Function.prototype.myCall without calling the native call. The key insight: to invoke fn with thisArg as this, attach fn to thisArg as a temporary property, call it as a method, then remove the property.`,
	...
	},
	{
		...
		sourceUrl: "https://www.greatfrontend.com/interviews/gfe75",
		solutionTypes: [],
		tags: [Tag.Async, Tag.HigherOrderFunction],
		status: QuestionStatus.Todo,
	...
	},
	{
		...
		sourceUrl: "https://www.greatfrontend.com/interviews/gfe75",
		solutionTypes: [],
		tags: [Tag.HigherOrderFunction, Tag.Closure],
		status: QuestionStatus.Todo,
	...
	},
	{
		...
		solutionTypes: [SolutionType.Writeup],
		tags: [Tag.WebAPIs, Tag.WebStorage],
		status: QuestionStatus.Done,
	...
	},
	{
		...
		sourceUrl: "https://www.greatfrontend.com/interviews/gfe75",
		solutionTypes: [SolutionType.Writeup],
		tags: [Tag.Closure, Tag.JavaScript],
		status: QuestionStatus.Todo,
	...
	},
	{
		...
		sourceUrl: "https://www.greatfrontend.com/interviews/gfe75",
		solutionTypes: [SolutionType.Writeup],
		tags: [Tag.WebAPIs, Tag.JavaScript],
		status: QuestionStatus.Todo,
	...
	},
	{
		...
		sourceUrl: "https://www.greatfrontend.com/interviews/gfe75",
		solutionTypes: [SolutionType.Writeup],
		tags: [Tag.Html, Tag.Internationalization],
		status: QuestionStatus.Todo,
	...
	},
	{
		...
		sourceUrl: "https://www.greatfrontend.com/interviews/gfe75",
		solutionTypes: [SolutionType.UiDemo],
		tags: [Tag.UiComponent, Tag.Accessibility],
		status: QuestionStatus.Todo,
