...
const CODE_LINES: CodeLine[] = [
	...
	{ line: 3, code: "const MATCHES = { ')': '(', '}': '{', ']': '[' };" },
	{ line: 9, code: "const OPEN_TO_CLOSE = { '(': ')', '{': '}', '[': ']' };" },
	{ line: null, code: "" },
	{
		line: 23,
		code: "export function getBalancedBracketSteps(input: string) {",
	},
	{ line: 24, code: "  const steps: BracketStep[] = [];" },
	{ line: 25, code: "  const stack: string[] = [];" },
	{ line: 27, code: "  for (const token of input) {" },
	{ line: 28, code: "    if (OPENING.has(token)) {" },
	{ line: 29, code: "      stack.push(token);" },
	{ line: 37, code: "      continue;" },
	{ line: null, code: "    }" },
	{ line: 40, code: "    const expected = MATCHES[token];" },
	{ line: 41, code: "    const top = stack[stack.length - 1];" },
	{ line: 42, code: "    const valid = top === expected;" },
	{ line: 44, code: "    if (!valid) {" },
	{
		line: 45,
		code: '      const expectedClose = top ? OPEN_TO_CLOSE[top] : "opening bracket";',
	},
	{ line: 52, code: "      return false;" },
	{ line: null, code: "    }" },
	{ line: 55, code: "    stack.pop();" },
	{ line: null, code: "  }" },
	{ line: 61, code: "  return stack.length === 0;" },
	{ line: null, code: "}" },
];
